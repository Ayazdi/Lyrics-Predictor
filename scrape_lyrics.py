...
def scrape_artist_lyrics(artist):
    """This function will scrape lyrics of the first 2 pages of the given artist from metrolyrics.com and put in a dataframe and save it as .csv file in the folder."""
